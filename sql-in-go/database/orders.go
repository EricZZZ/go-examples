...
func (r *OrderRespository) CreateTable() error {
...
func (r *OrderRespository) Insert(order Order) error {
	_, err := r.Db.Exec("INSERT INTO orders (product, amount) VALUES (?,?)", order.Product, order.Amount)
	return err
}

func (r *OrderRespository) GetAll() ([]Order, error) {
...
func (r *OrderRespository) GetById(id int) (Order, error) {
	var order Order
